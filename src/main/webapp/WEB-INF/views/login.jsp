...
<head>
    ...
    <link href="${metronicUrl}/assets/global/plugins/select2/select2.css" rel="stylesheet" type="text/css"/>
    <link href="${metronicUrl}/assets/admin/pages/css/login.css" rel="stylesheet" type="text/css"/>
    ...
    <link id="style_color" href="${metronicUrl}/assets/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css"/>
...
--%>
    ...
    <form class="login-form" action="j_spring_security_check" method="post">
        <h3 class="form-title">Войти в систему</h3>
        ...
        <div class="form-actions">
            <label class="checkbox">
                <input type="checkbox" name="_spring_security_remember_me" value="1"/> Запомнить меня </label>
            <button type="submit" class="btn green pull-right"> Войти <i class="m-icon-swapright m-icon-white"></i>
            </button>
        </div>
        <%--
...
<!-- END LOGIN -->
<!-- BEGIN COPYRIGHT -->
<div class="copyright"> 2015 &copy; lafox.net</div>
<!-- END COPYRIGHT -->
...
<script src="${metronicUrl}/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
...
<script src="${metronicUrl}/assets/admin/pages/scripts/login.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
